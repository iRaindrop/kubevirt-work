---
mode: agent
description: Run the full `maintenance-planning` analysis (answers, comment, and recommendations) for the documentation.
---

Run the shared **full** analysis for the `maintenance-planning` criteria area.

1. Read the criteria definition in `.github/prompts/criteria/maintenance-planning.md`.
2. Read and follow the shared procedure in `.github/prompts/full.prompt.md`, treating `maintenance-planning` as the selected area.
